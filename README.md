...
A responsive and user-friendly **Weather Application** built with **React.js** and **Vite** that provides real-time weather information using the **OpenWeatherMap API**.
